                  ...
                  <div class="col-md-6">
                        ...
                        <ul class="list-group">
                              ...
                              <li class="list-group-item">
                                    <?= $mk['nama_mk']; ?>
                                    <a href="<?= base_url(); ?>mahasiswa/mataKuliah_api/hapus/<?= $mk['kode_mk']; ?>" class="badge badge-danger float-right" onclick="return confirm('Apakah data akan dihapus?')">hapus</a>
